...
class SkillInfo:
    ...
    description_zh: str = ""     # 中文描述（i18n）
    body_zh: str = ""            # 中文正文（i18n）
        ...
        if fm_match:
            ...
            try:
                ...
                if isinstance(fm_data, dict):
                    ...
                    info.description_zh = str(fm_data.get("description_zh", ""))
                    info.body_zh = str(fm_data.get("body_zh", ""))
                    # triggers — 保持兼容，过滤空值
