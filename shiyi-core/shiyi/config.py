...
DEFAULT_CONFIG: Dict[str, Any] = {
    ...
    "llm": {
        "main_model": "deepseek-v4-pro",      # 主LLM模型（回复生成）
        "light_model": "deepseek-v4-flash",   # 轻量LLM模型（意图识别等感知层）
        "main_base": "https://api.deepseek.com",   # 主LLM API地址
        "light_base": "https://api.deepseek.com",  # 轻量LLM API地址
    },
    "embedding": {
        "provider": "auto",                               # auto | deepseek | siliconflow | bge
        "deepseek_model": "deepseek-embed",               # DeepSeek embedding模型
        "siliconflow_model": "BAAI/bge-m3",               # SiliconFlow embedding模型
        "siliconflow_base": "https://api.siliconflow.cn/v1",  # SiliconFlow API地址
    },
}
...
class Config:
    ...
    def version(self) -> str:
        """版本号"""
        return self._config.get("version", "0.11.1")
    ...
    def memory(self) -> Dict[str, Any]:
        """记忆配置"""
        return self._config.get("memory", DEFAULT_CONFIG["memory"])
    ...
    def embedding(self) -> Dict[str, Any]:
        """Embedding配置"""
        return self._config.get("embedding", DEFAULT_CONFIG["embedding"])
