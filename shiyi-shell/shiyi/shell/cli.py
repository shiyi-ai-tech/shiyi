    ...
    if shiyi:
        try:
            ...
            if mcp_script.exists():
                ...
                promoted = shiyi.clerk_registry.promote_clerk_tools_to_global(remote_clerk.config.clerk_id)
                ...
                promoted = shiyi.clerk_registry.promote_clerk_tools_to_global(local_clerk.config.clerk_id)
